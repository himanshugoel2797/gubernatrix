...
#ifndef MADT_ACPI_TABLE_H
#define MADT_ACPI_TABLE_H
...
#define MADT_IOAPIC_NMI_ENTRY_TYPE                                             \
  3 //!< The type ID describing an IO APIC NMI mapping entry
...
#define MADT_APIC_NMI_ENTRY_TYPE                                               \
  4 //!< The type ID describing a Local APIC NMI mapping entry
